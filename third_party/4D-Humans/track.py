...
class HMR2_4dhuman(PHALP):
    ...
    def setup_hmr(self):
        # Swap from HMR2023TextureSampler to HMR2Predictor to avoid the
        # neural_renderer CUDA dependency (incompatible with torch 2.11+ /
        # Blackwell sm_120). Loses appearance-via-texture-sampling but keeps
        # 3D pose-based tracking.
